...
- Die Ortssuche verwendet die Geocoding-API von Open-Meteo mit Ortsdaten von GeoNames und benötigt eine Internetverbindung. Sie ist auf Orte in Deutschland beschränkt.
